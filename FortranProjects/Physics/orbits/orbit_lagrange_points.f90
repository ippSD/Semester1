module orbit_lagrange_points
    ...
    !   ( TYPE ) LagrangePoints                                             !
    !-----------------------------------------------------------------------!
    !   Stores the required data in order to simulate the two-body Lagrange !
    !   Points.                                                             !
    !-----------------------------------------------------------------------!
    !   Atributes: !                                                        !
    !--------------!--------------------------------------------------------!
    !              ! (real) mu_1                                            !
    !              ! Standard Gravitational Parameter (GM) of the           !
    !              ! main body.                                             !
    !--------------!--------------------------------------------------------!
    !              ! (real) mu_1                                            !
    !              ! Standard Gravitational Parameter (GM) of the           !
    ...
    !--------------!--------------------------------------------------------!
    !              ! (real) sma                                             !
    !              ! Semi Major Axis (SMA) of the secondary body            !
    !              ! around the main body.                                  !
    !--------------!--------------------------------------------------------!
    !              ! (real(5)) r_li_sma                                     !
    !              ! Distance of the Lagrange Point meassured from the      !
    !              ! main body divided by the SMA.                          !
    !--------------!--------------------------------------------------------!
    !              ! (real(5)) theta_li                                     !
    !              ! Angle formed by the position of the Lagrange Point     !
    !              ! and the line of the centers of the two bodies.         !
    !--------------!--------------------------------------------------------!
    type LagrangePoints
        real :: mu_1
        real :: mu_2
    ...
    !-----------------------------------------------------------------------!
    !   ( LagrangePoints ) LP_EARTH_MOON                                    !
    !-----------------------------------------------------------------------!
    !   Stores the Lagrange Points of the Earth-Moon two-body system.       !
    !-----------------------------------------------------------------------!
...
end module orbit_lagrange_points
