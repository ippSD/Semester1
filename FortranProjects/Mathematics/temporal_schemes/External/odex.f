...
! -------- UROUND   SMALLEST NUMBER SATISFYING 1.D0+UROUND>1.D0  
      ...
      ELSE
         ...
         IF(UROUND.LE.1.D-35.OR.UROUND.GE.1.D0)THEN
            WRITE(6,*) ' WHICH MACHINE DO YOU HAVE? YOUR UROUND WAS:',WORK(1)
            ARRET=.TRUE.
         END IF
      END IF
! -------- MAXIMAL STEP SIZE
...
! --- BASIC INTEGRATION STEP  
  30   CONTINUE
       ...
       DO 40 J=1,KC
       CALL MIDEX(J,X,Y,H,HMAX,N,FCN,DY,YH1,YH2,DZ,T,NJ,HH,W,  &
         ERR,FAC,A,SAFE1,UROUND,FAC1,FAC2,SAFE2,SCAL,ATOV,SAFE3,REJECT,&
         KM,RTOL,ATOL,ITOL,MSTAB,JSTAB,ERROLD,FSAFE,LFSAFE,IOUT,IPT,&
         YSAFE,ICOMP,NRD,RPAR,IPAR,NFCN)
       IF (ATOV) GO TO 10
  40   CONTINUE
! --- CONVERGENCE MONITOR
...
! --- FAIL EXIT
 ...
 979   FORMAT(' EXIT OF ODEX AT X=',D14.7,'   H=',D14.7)
       ...
       END  
!
       SUBROUTINE MIDEX(J, X, Y, H, HMAX, N, FCN, DY, YH1, YH2, DZ, T, &
          NJ, HH, W, ERR, FAC,A,SAFE1,UROUND,FAC1,FAC2,SAFE2,SCAL,ATOV, &
          SAFE3, REJECT, KM, RTOL, ATOL,ITOL, MSTAB, JSTAB, ERROLD, &
          FSAFE, LFSAFE, IOUT, IPT, YSAFE, ICOMP, NRD, RPAR, &
          IPAR, NFCN)
