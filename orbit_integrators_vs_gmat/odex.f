...
! --- BASIC INTEGRATION STEP  
  30   CONTINUE
       ...
       KC=K-1
       DO 40 J=1,KC
       CALL MIDEX(J,X,Y,H,HMAX,N,FCN,DY,YH1,YH2,DZ,T,NJ,HH,W,   ERR,FAC,A,SAFE1,UROUND,FAC1,FAC2,SAFE2,SCAL,ATOV,SAFE3,REJECT,KM,RTOL,ATOL,ITOL,MSTAB,JSTAB,ERROLD,FSAFE,LFSAFE,IOUT,IPT,YSAFE,ICOMP,NRD,RPAR,IPAR,NFCN)
       IF (ATOV) GO TO 10
  40   CONTINUE
! --- CONVERGENCE MONITOR
  ...
  50   CONTINUE
       CALL MIDEX(K,X,Y,H,HMAX,N,FCN,DY,YH1,YH2,DZ,T,NJ,HH,W,ERR,FAC,A,SAFE1,UROUND,FAC1,FAC2,SAFE2,SCAL,ATOV,SAFE3,REJECT,KM,RTOL,ATOL,ITOL,MSTAB,JSTAB,ERROLD,FSAFE,LFSAFE,IOUT,IPT,YSAFE,ICOMP,NRD,RPAR,IPAR,NFCN)
       IF (ATOV) GO TO 10
       KC=K 
       IF (ERR.LE.1.D0) GO TO 60
! --- HOPE FOR CONVERGENCE IN LINE K+1
  55   CONTINUE
       ...
       KC=K+1
       CALL MIDEX(KC,X,Y,H,HMAX,N,FCN,DY,YH1,YH2,DZ,T,NJ,HH,W,ERR,FAC,A,SAFE1,UROUND,FAC1,FAC2,SAFE2,SCAL,ATOV,SAFE3,REJECT,KM,RTOL,ATOL,ITOL,MSTAB,JSTAB,ERROLD,FSAFE,LFSAFE,IOUT,IPT,YSAFE,ICOMP,NRD,RPAR,IPAR,NFCN)
       IF (ATOV) GO TO 10
...
! --- FAIL EXIT
 ...
 979   FORMAT(' EXIT OF ODEX AT X=',D14.7,'   H=',D14.7)
       ...
       END  
!
       SUBROUTINE MIDEX(J, X,Y,H,HMAX,N,FCN,DY,YH1,YH2,DZ,T,NJ,HH,W,ERR,FAC,A,SAFE1,UROUND,FAC1,FAC2,SAFE2,SCAL,ATOV,SAFE3, REJECT, KM, RTOL, ATOL,ITOL, MSTAB, JSTAB, ERROLD, FSAFE, LFSAFE, IOUT, IPT, YSAFE, ICOMP, NRD, RPAR, IPAR, NFCN)
